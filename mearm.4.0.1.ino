...
//  z = joy_to_pos(joy_1y_pin);
//  r = joy_to_pos(joy_2y_pin);

//  int r;
//  r = analogRead(joy_1y_pin);
//  Serial.print("joy: ");
//  Serial.println(r);
//  r = map(r, 0, 1023, 0, 156);
//  Serial.print("pos: ");
//  Serial.println(r);
//
//  int z;
//  z = analogRead(joy_2y_pin);
//  Serial.print("joy: ");
//  Serial.println(z);
//  z = map(z, 0, 1023, 0, 78);
//  Serial.print("pos: ");
...
////////////////////////////
  ...
  r_angle_p = ((atan(z/r))+.5*acos((pow(r,2)+pow(z,2))/(2*pow(l,2))-1)* (180 / 3.1416));
  l_angle_th = 180-(acos(((pow(r,2)+pow(z,2))/(2*pow(l,2)))-1)-atan(z/r))* (180 / 3.1416);
  ...
  //delay(1000);
  //move to min extend
  servo_R.write((int)r_angle_p);
  servo_L.write((int)l_angle_th);
  //delay(1000);
}
